...
{
	private final SessionCostTrackerPanel.Controls controls;
	...
	TargetedContent(SessionCostTrackerPanel.Controls controls, ItemManager itemManager)
	{
		...
		render(SessionCostTrackerPanel.View.builder().build());
	}
	...
	void render(SessionCostTrackerPanel.View view)
	{
		...
		killPanel.removeAll();
		for (SessionCostTrackerPanel.KillRow k : view.getKillRows())
		{
		...
		if (farm)
		{
			for (SessionCostTrackerPanel.DeathRow d : view.getDeaths())
			{
	...
	private void fillLines(JPanel holder, JPanel body, boolean show, java.util.List<SessionCostTrackerPanel.EventLine> lines)
	{
		holder.setVisible(show && !lines.isEmpty());
		body.removeAll();
		for (SessionCostTrackerPanel.EventLine line : lines)
		{
